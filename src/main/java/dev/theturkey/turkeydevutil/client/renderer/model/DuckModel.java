package dev.theturkey.turkeydevutil.client.renderer.model;
...
public class DuckModel<T extends Entity> extends AgeableListModel<T>
{
	...
	public DuckModel(ModelPart p_170490_)
	{
	...
	public void setupAnim(@NotNull T p_102392_, float p_102393_, float p_102394_, float p_102395_, float p_102396_, float p_102397_)
	{
